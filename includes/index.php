      ...
      <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
          <div class="site-heading">
            <h1>Mon Portfolio</h1>
            <span class="subheading">Tous savoir sur moi!</span>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-lg-8 col-md-10 mx-auto">
        <div class="post-preview">
          <a href="a_propos.php">
            <h2 class="post-title">
             2019/2020 RSMA/SIMPLON
            </h2>
            <h3 class="post-subtitle">
            Formation Développeur-Web et Web mobile(en cours)
            - (Titre pro Niveau V)
            </h3>
          </a>
          <p class="post-meta">Développeur-Web de Site ou applications web.
            Analyser les besoins du client,
            Établir un cahier des charges, Langages de programmation</p>
        </div>
        <hr>
        <div class="post-preview">
          <a href="a_propos.php">
            <h2 class="post-title">
             2016/2017 Formation Hôtellerie (C.A.P)
            </h2>
        ...
        <div class="post-preview">
          <a href="a_propos.php">
            <h2 class="post-title">
              2015/2016 Formation Hôtellerie / restauration Bac technologique.
            </h2>
            <h3 class="post-subtitle">
            Tabla Pizza (Stage)
            </h3>
        ...
        <hr>
          <!-- Pager -->
  <div class="clearfix">
          <a class="btn btn-primary float-right" href="a_propos.php">Page suivante &rarr;</a>
  </div>
      </div>
    </div>
  </div>
