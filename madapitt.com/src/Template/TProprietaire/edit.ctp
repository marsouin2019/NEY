...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $tProprietaire->idproprietaire],
                ['confirm' => __('Are you sure you want to delete # {0}?', $tProprietaire->idproprietaire)]
            )
        ?></li>
...
<div class="tProprietaire form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit T Proprietaire') ?></legend>
        <?php
